                ...
                <div className="col-sm-9 mt-3">
                    <div className="card">
                        <div className="card-body">
                           <Link to={'/cliente/empresa/create'} className='btn btn-primary'>Agregar Empresa</Link>
                                    ...
                                    {empresa.length === 0 ? (
                                        ...
                                        empresa.map((empresa) => (
                                            <tr key={empresa.id}>
                                                ...
                                                <td>
                                                    <Link to={`/cliente/empresa/edit/${empresa.id}`} className='btn btn-primary me-2'>Editar</Link>
                                                    <button
